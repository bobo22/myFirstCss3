 ...
 * 
 * 业务封装实现+type3皮肤 
 * 需要依赖于 PullToRefresh_Skin_Css
 */
define(function(require, exports, module) {
	// 引入实现的核心
	var PullRefreshImplCore = require('PullToRefresh_Bizlogic_Impl');
	//  引入下拉刷新的核心
	var PullRefreshBase = require('PullToRefresh_Skin_Type3');
	//css支持
	CommonTools.importFile('js/core/RayApp/PullToRefresh/PullToRefresh-Skin.css');
	/**
	 * @description 初始化下拉刷新
