...
(function(win) {
	...
	seajs.config({
		...
		alias: {
			...
			//DES3工具类，该加密方式为可逆，得需要对方加密时的密钥，才可以解密
			'DES3Tools_Core': 'js/core/RayApp/Tools/Tools.DES3.js',
			//字符串加密操作相关操作-纯h5
			...
			'SqlTools_Core': 'js/core/RayApp/Tools/Tools.Sql.js',
			...
			'PullToRefresh_Base_Type1Material1_Core': 'js/core/RayApp/Tools/Tools.PullToRefresh.Base.Type1.material1.js',
			'PullToRefresh_Base_Type2_Core': 'js/core/RayApp/Tools/Tools.PullToRefresh.Base.Type2.js',
			//下拉刷新实现的核心代码
			'PullToRefresh_Impl_Core': 'js/core/RayApp/Tools/Tools.PullToRefresh.Impl.core.js',
			//下拉刷新实现-默认实现(基于mui的重写)操作相关操作-纯h5
			'PullToRefresh_Impl_Default_Core': 'js/core/RayApp/Tools/Tools.PullToRefresh.Impl.default.js',
			//下拉刷新实现-type0
			'PullToRefresh_Impl_Type0_Core': 'js/core/RayApp/Tools/Tools.PullToRefresh.Impl.type0.js',
			//下拉刷新实现-type1
			'PullToRefresh_Impl_Type1_Core': 'js/core/RayApp/Tools/Tools.PullToRefresh.Impl.type1.js',
			//下拉刷新实现-type1Material
			'PullToRefresh_Impl_Type1Material_Core': 'js/core/RayApp/Tools/Tools.PullToRefresh.Impl.type1Material.js',
			//下拉刷新实现-type2
			'PullToRefresh_Impl_Type2_Core': 'js/core/RayApp/Tools/Tools.PullToRefresh.Impl.type2.js',
			//文件上传
			...
			'BaiDuMap_Core': 'js/core/RayApp/Tools/Tools.BaiDuMap.js',
			//钉钉下的增强组件，针对ejs进行增强
			'Extend_Component_DD': 'js/core/RayApp/Tools/Tools.DDExtendComponent.js',
			...
			//新增的下拉刷新相关
			//下拉刷新基于的 IScroll
			'PullToRefresh_IScroll_Probe': 'js/core/RayApp/PullToRefresh/Tools.PullToRefresh.IScroll.Probe.js',
			//下拉刷新的皮肤  default 默认样式
			'PullToRefresh_Skin_Default': 'js/core/RayApp/PullToRefresh/Tools.PullToRefresh.Skin.Default.js',
			//下拉刷新的皮肤  type1 默认样式
			'PullToRefresh_Skin_Type1': 'js/core/RayApp/PullToRefresh/Tools.PullToRefresh.Skin.Type1.js',
			//下拉刷新的皮肤  type2 自定义图片
			'PullToRefresh_Skin_Type2': 'js/core/RayApp/PullToRefresh/Tools.PullToRefresh.Skin.Type2.js',
			//下拉刷新的皮肤  type3 canvas球
			'PullToRefresh_Skin_Type3': 'js/core/RayApp/PullToRefresh/Tools.PullToRefresh.Skin.Type3.js',
			//下拉刷新的皮肤  type4 css3弹性小球
			'PullToRefresh_Skin_Type4': 'js/core/RayApp/PullToRefresh/Tools.PullToRefresh.Skin.Type4.js',
			//下拉刷新的皮肤  native 在ejs或钉钉环境下使用(可以直接使用原生提供的下拉刷新动画)
			'PullToRefresh_Skin_Native': 'js/core/RayApp/PullToRefresh/Tools.PullToRefresh.Skin.Native.js',
			//下拉刷新的皮肤 mui default
			'PullToRefresh_Skin_Mui_Default': 'js/core/RayApp/PullToRefresh/Tools.PullToRefresh.Skin.Mui.Default.js',
			//下拉刷新的皮肤 mui type1
			'PullToRefresh_Skin_Mui_Type1': 'js/core/RayApp/PullToRefresh/Tools.PullToRefresh.Skin.Mui.Type1.js',
			//下拉刷新的皮肤 mui type2
			'PullToRefresh_Skin_Mui_Type2': 'js/core/RayApp/PullToRefresh/Tools.PullToRefresh.Skin.Mui.Type2.js',
			//下拉刷新的皮肤 mui type3
			'PullToRefresh_Skin_Mui_Type3': 'js/core/RayApp/PullToRefresh/Tools.PullToRefresh.Skin.Mui.Type3.js',

			//下拉刷新的业务实现(里面进一步封装，默认会对接口数据进行处理，业务开发时一般会使用这个，翻页逻辑里面自动处理)
			//一般一个业务实现+一个上面的皮肤  就是项目中最长用到的下拉刷新场景
			'PullToRefresh_Bizlogic_Core': 'js/core/RayApp/PullToRefresh/Tools.PullToRefresh.Bizlogic.Impl.js',
			//业务同时封装皮肤
			'PullToRefresh_Bizlogic_Skin_Default': 'js/core/RayApp/PullToRefresh/Tools.PullToRefresh.Bizlogic.Skin.Default.js',
			'PullToRefresh_Bizlogic_Skin_Type1': 'js/core/RayApp/PullToRefresh/Tools.PullToRefresh.Bizlogic.Skin.Type1.js',
			'PullToRefresh_Bizlogic_Skin_Type2': 'js/core/RayApp/PullToRefresh/Tools.PullToRefresh.Bizlogic.Skin.Type2.js',
			'PullToRefresh_Bizlogic_Skin_Type3': 'js/core/RayApp/PullToRefresh/Tools.PullToRefresh.Bizlogic.Skin.Type3.js',
			'PullToRefresh_Bizlogic_Skin_Type4': 'js/core/RayApp/PullToRefresh/Tools.PullToRefresh.Bizlogic.Skin.Type4.js',
			'PullToRefresh_Bizlogic_Skin_Mui_Default': 'js/core/RayApp/PullToRefresh/Tools.PullToRefresh.Bizlogic.Skin.Mui.Default.js',
			'PullToRefresh_Bizlogic_Skin_Mui_Type1': 'js/core/RayApp/PullToRefresh/Tools.PullToRefresh.Bizlogic.Skin.Mui.Type1.js',
			'PullToRefresh_Bizlogic_Skin_Mui_Type2': 'js/core/RayApp/PullToRefresh/Tools.PullToRefresh.Bizlogic.Skin.Mui.Type2.js',
			'PullToRefresh_Bizlogic_Skin_Mui_Type3': 'js/core/RayApp/PullToRefresh/Tools.PullToRefresh.Bizlogic.Skin.Mui.Type3.js',
			//配置通用ajax
			'commonajax': 'js/bizlogic/common/commonajax.js',
			//配置通用ajax
			'commonApi': 'js/bizlogic/config/commonApi.js'
		},
		// 路径配置,可以在这里配置一些通用的路径
