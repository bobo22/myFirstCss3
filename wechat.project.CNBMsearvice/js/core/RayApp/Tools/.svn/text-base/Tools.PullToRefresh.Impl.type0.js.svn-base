 ...
 * @time 2017-01-18
 * 功能模块:
 * 下拉刷新type0皮肤的实现，由于采用了webpack打包模式，
 * 所以皮肤都应该在初始化时就已经确定
 */
define(function(require, exports, module) {
	...
	//  引入下拉刷新的核心
	var PullRefreshBase = require('PullToRefresh_Base_Type0_Core');
	//var PullRefreshBase = require('js/core/RayApp/Tools/Tools.PullToRefresh.Skin.Default.js');
